...
<meta name="Description"
	content="As a forward thinking school, our mission focuses on the provision of the highest level of International standards in education adopting the Cambridge International and British National Curricula.">
		...
		<div>
			<div class="grid1-2">
				<div class="intro">
					...
					<p>Recognized as a young and forward-thinking school, ARIS is an outstanding place for students and
						teachers alike. <a href="{{url('/about-us/why-aris')}}" class="learnmore">Learn
							More&nbsp;&rarr;</a></p>
				</div>
...
<div class="section">
	<div class="inner" style="margin-bottom:3.5em">
		...
		<div class="grid2-2">
			<a href="http://www.cambridgeinternational.org/"><img src={{asset('/img/cambridge.png')}} width="50%"
					height="50%"></a>
		</div>
		<div class="grid1-2">
